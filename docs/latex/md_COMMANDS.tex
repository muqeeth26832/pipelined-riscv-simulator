\chapter{Commands}
\hypertarget{md_COMMANDS}{}\label{md_COMMANDS}\index{Commands@{Commands}}
\label{md_COMMANDS_autotoc_md0}%
\Hypertarget{md_COMMANDS_autotoc_md0}%
...
\begin{DoxyItemize}
\item {\ttfamily processor\+\_\+type} (string) \+: {\ttfamily single\+\_\+stage} \texorpdfstring{$\vert$}{|} {\ttfamily multi\+\_\+stage} ~\newline

\item {\ttfamily run\+\_\+step\+\_\+delay} (unsigned int) \+: milliseconds
\item {\ttfamily instruction\+\_\+execution\+\_\+limit} (unsigned int) \+: Specifies the number of instruction to run on one use of {\ttfamily run} button. Set to {\ttfamily 0} for no limit.
\end{DoxyItemize}
\item {\ttfamily \doxylink{classMemory}{Memory}}
\begin{DoxyItemize}
